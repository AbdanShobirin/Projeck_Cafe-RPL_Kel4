...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_transaksi.php">Daftar Transaksi</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Daftar Transaksi</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="entri_transaksi.php"><i class="icon icon-inbox"></i> <span>Daftar Transaksi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_transaksi.php" title="Go to here" class="tip-bottom"><i class="icon icon-inbox"></i> Daftar Transaksi</a></div>
  </div>
<!--End-breadcrumbs-->
